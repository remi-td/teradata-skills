...
This repository is a marketplace index for Teradata skills across Claude Code, Codex, Cursor, and VS Code agent surfaces.

Use [CONTRIBUTING.md](CONTRIBUTING.md) as the source of truth for adding or changing skills. It contains the required manifest shapes, examples, and validation commands.

## Repository Rules

- Keep external skill code in the source repository. Do not copy external skill packages into this repo.
...
When changing existing Codex entries, install the affected plugins in the same temporary `CODEX_HOME`.
